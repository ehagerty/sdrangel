...
#ifndef _USRPMIMO_USRPMIMOPLUGIN_H
#define _USRPMIMO_USRPMIMOPLUGIN_H
...
#define USRPMIMO_DEVICE_TYPE_ID "sdrangel.samplemimo.usrpmimo"

class USRPMIMOPlugin : public QObject, public PluginInterface {
	Q_OBJECT
	Q_INTERFACES(PluginInterface)
	Q_PLUGIN_METADATA(IID USRPMIMO_DEVICE_TYPE_ID)

public:
	explicit USRPMIMOPlugin(QObject* parent = nullptr);
...
#endif // _USRPMIMO_USRPMIMOPLUGIN_H
